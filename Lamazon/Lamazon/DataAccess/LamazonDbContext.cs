...
namespace Lamazon.DataAccess
{
    public class LamazonDbContext : IdentityDbContext<User>
    {
        ...
        public void Seed(ModelBuilder modelBuilder)
        {
            ...
            string filipId = Guid.NewGuid().ToString();
            ...
            modelBuilder.Entity<Order>().HasData(
                new Order { Id = 1, DateOfOrder = DateTime.UtcNow, Status = StatusType.Init, UserId = filipId },
                new Order { Id = 2, DateOfOrder = DateTime.UtcNow, Status = StatusType.Pending, UserId = filipId });
            ...
            modelBuilder.Entity<ProductOrder>().HasData(
                ...
                ////   Ne mi e jasno tuka sto se desava ( kreira produkti za order so id ? )
                //Order 2
